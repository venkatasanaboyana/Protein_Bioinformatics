...
sub AHEMODEL {
	...
	`ssh $user\@$IP "cd /home/$user/$directory/$uniprot;cp /home/vsanaboyana/PhD/ECOLI_STRUCTURES/AIDA/ADDITIONAL_SOFTWARES/WHOLE_ASSEMBLY/SUBMIT_AHEMODEL.sh .;bash SUBMIT_AHEMODEL.sh $pdb_wo_chain $chain $fasta"`; 	
}
